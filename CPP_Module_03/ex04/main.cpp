...
void 	testSupertrap() {
	...
	super.rangedAttack("some");
	super.meleeAttack("some other");
	super.ninjaShoebox(ninja);
	super.vaulthunter_dot_exe("random target");

	std::cout << std::endl;
	std::cout << std::endl;

	SuperTrap superclone(super);
...
//	testNinjatrap();
	...
	std::cout << std::endl << WITH_BG << "CHECK SUPER" << RESET << std::endl << std::endl;
	testSupertrap();
